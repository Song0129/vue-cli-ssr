  ...
  <div class="leftNav">
    <div class="logo">
      <a href="/" class="router-link-active">
        <h1 v-if="!collapsed">
          <svg t="1597989581210" class="icon" viewBox="0 0 1024 1024" version="1.1"
               xmlns="http://www.w3.org/2000/svg" p-id="4448" width="30" height="30">
            <path d="M218.112 64h583.296L1024 384.768 509.76 960 0 384.768 218.112 64z m286.08 504.192l-252.48-287.36-86.72 91.968 339.2 366.464 329.28-366.464-77.184-91.968-252.096 287.36z"
                  fill="#fff" p-id="4449"></path>
          </svg>
    ...
    >
      <template v-for="menu in menuList">
        ...
        <a-sub-menu v-else :key="menu.id">
          <span slot="title"><a-icon type="mail"/><span>{{menu.name}}</span></span>
